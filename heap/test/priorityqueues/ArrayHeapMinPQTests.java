...
public class ArrayHeapMinPQTests extends BaseTest {
    ...
    class Miscellaneous {
        ...
        void myOwn() {
            ...
            pq.add("Nancy", 15);
            pq.changePriority("Nancy", -10);
            pq.changePriority("Eponine", 8);

            assertThat(pq.removeMin()).isEqualTo("Nancy");
            //assertThat(pq.removeMin()).isEqualTo("Eponine");
            assertThat(pq.removeMin()).isEqualTo("Thenardier");
            assertThat(pq.removeMin()).isEqualTo("Jean Valjean");
            assertThat(pq).isValid();
        }
        ...
        void myOwn2() {
            ...
            pq.add("0", 0);
            pq.add("6", -1);
            pq.changePriority("6", 10);

            assertThat(pq.removeMin()).isEqualTo("0");
